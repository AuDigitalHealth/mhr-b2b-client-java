...
This library (**`au.gov.nehta:mhr-b2b-client`**, Maven line **24.0.0**, Java **24** / **Jakarta**) implements the **vendor-facing My Health Record B2B** interfaces listed by **mhr-b2b-client-dotnet** (logical names below). Wire SOAP still uses published **`pcehr`** namespaces and operation names; Java packages and type names use **`mhr`**.
