 ...
 * under the License.
 */
package au.gov.nehta.vendorlibrary.mhr.test._20120718_regression.tests.view;

import au.gov.nehta.vendorlibrary.mhr.clients.common.constant.XDSConstants;
import au.gov.nehta.vendorlibrary.mhr.clients.common.type.*;
...
public class GetDocumentListClientTest {
    ...
    public void test_ServiceStartTime() throws Exception {
        ...
        MHRHeader request = getKnownIHIHeader();
     ...
     * @return The header
     */
    public MHRHeader getKnownIHIHeader() {
        MHRHeader request = MessageComponents.createRequest
                (
                        MessageComponents.createUser(MHRHeader.User.IDType.HPII, "8003619166674595", null, "Ross John", false),
                        "8003606789133695",
