 ...
 */
public final class DoesMHRExistSample {

  private DoesMHRExistSample() {

  }

  public static void main(String[] args) throws IOException, GeneralSecurityException, StandardErrorMsg {

    DoesMHRExistClient client;

    // Sets the newly created sslsocketfactory as the default for all instances of
    ...
    // Call operation.
    DoesMHRExistResponse response = client.doesPCEHRExist(commonHeader);
