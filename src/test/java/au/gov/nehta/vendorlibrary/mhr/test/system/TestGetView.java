package au.gov.nehta.vendorlibrary.mhr.test.system;
...
import au.gov.nehta.vendorlibrary.mhr.test.utils.SecurityConstants;
...
//				    Endpoints.ACCENTURE__VPN__GET_VIEW,
        ...
        MHRHeader request = MessageComponents.createRequest
                (
                        MessageComponents.createUser(MHRHeader.User.IDType.HPII, "pwilford", null, "PhilipWilford", false),
                        "8003602345690302",
