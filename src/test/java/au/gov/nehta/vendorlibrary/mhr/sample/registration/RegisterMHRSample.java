 ...
 * under the License.
 */
package au.gov.nehta.vendorlibrary.mhr.sample.registration;

import au.gov.nehta.vendorlibrary.mhr.clients.common.type.DocumentConsentCodes;
import au.gov.nehta.vendorlibrary.mhr.clients.common.type.EvidenceOfIdentityCodes;
...
import au.net.electronichealth.ns.mhr.xsd.interfaces.registermhr._2.RegisterMHR.Representative;
import au.net.electronichealth.ns.mhr.xsd.interfaces.registermhr._2.RegisterMHR.Assertions.DocumentConsent;
...
import au.net.electronichealth.ns.mhr.xsd.interfaces.registermhr._2.RegisterMHR.Assertions.DocumentConsent.Document;
 ...
 */
public class RegisterMHRSample {
  ...
  public static void main(String[] args) throws
    ...
    au.net.electronichealth.ns.mhr.svc.registermhr._2.StandardErrorMsg {

    RegisterMHRClient client;
     ...
     *
     * 1. An IHI is provided in the MHRHeader (or in the child IHI, if registering a child for a PCEHR).
    ...
    RegisterMHR registrationDetails = generateChildWithIHI();

    // Register PCEHR - person w/demographics.
    // ** Uncomment ** RegisterMHR registrationDetails = generatePersonWithDemographics();

    // Call operation.
    RegisterMHRResponse response = client.registerPCEHR(commonHeader, registrationDetails);
   ...
   *
   * @return Populated {@link RegisterMHR}
   */
  private static RegisterMHR generateChildWithIHI() {
     ...
     */
    //RegisterMHR.Child child = new RegisterMHR.Child();
   ...
   * @return Populated {@link RegisterMHR}
   */
  private static RegisterMHR generatePersonWithDemographics() {
     ...
     */
    RegisterMHR.Individual individual = new RegisterMHR.Individual();

    RegisterMHR.Individual.Demographics demographics = new RegisterMHR.Individual.Demographics();
    ...
    RegisterMHR.Representative.Demographics repDemographics = new RegisterMHR.Representative.Demographics();
