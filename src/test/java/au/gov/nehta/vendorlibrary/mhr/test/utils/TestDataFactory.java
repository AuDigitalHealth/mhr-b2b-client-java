...
import au.net.electronichealth.ns.mhr.xsd.common.commoncoreelements._1.MHRHeader.AccessingOrganisation;
import au.net.electronichealth.ns.mhr.xsd.common.commoncoreelements._1.MHRHeader.ClientSystemType;
import au.net.electronichealth.ns.mhr.xsd.common.commoncoreelements._1.MHRHeader.ProductType;
import au.net.electronichealth.ns.mhr.xsd.common.commoncoreelements._1.MHRHeader.User;
import au.net.electronichealth.ns.mhr.xsd.common.commoncoreelements._1.MHRHeader.User.IDType;
...
public final class TestDataFactory {
    ...
    public static MHRHeader createValidMHRHeader() {
        User user = new User();
