...
public class GainMHRAccessClientTest_NOC {
  ...
  public void test_for_HealthMetrics() throws Exception {
	  ...
	  GainMHRAccessClient  client = new GainMHRAccessClient(
		      sslSocketFactory,
		      signingCertificate,
		      signingPrivateKey,
		      Endpoints.ACCENTURE_GAIN_PCEHR_ACCESS,
	  ...
	  MHRHeader request = MessageComponents.createRequest
		    ...
		    GainMHRAccess.MHRRecord record = MessageComponents.createGainMHRRecord
		      (
		        MessageComponents.createAuthorisationDetails(GainMHRAccess.MHRRecord.AuthorisationDetails.AccessType.EMERGENCY_ACCESS, null)
		      );
		    ...
		    GainMHRAccessResponse response=null;
  ...
  public void test_ForSterlingSystems() throws Exception {
    ...
    GainMHRAccessResponse gainAccess = client.gainPCEHRAccess(record, request);
  ...
  public void test_018() throws Exception {
    ...
    GainMHRAccessResponse response = client.gainPCEHRAccess(record, request);
  ...
  public void test_021() throws Exception {
    ...
    GainMHRAccess.MHRRecord record = MessageComponents.createGainMHRRecord(
      MessageComponents.createAuthorisationDetails(
        GainMHRAccess.MHRRecord.AuthorisationDetails.AccessType.ACCESS_CODE,
        "12345678"
      )
    );
