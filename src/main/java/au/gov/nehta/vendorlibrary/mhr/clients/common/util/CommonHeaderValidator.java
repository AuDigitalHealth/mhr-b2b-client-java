...
public final class CommonHeaderValidator {
    ...
    /**
     * Validate the contents of the {@link MHRHeader}.
     *
     * @param commonHeader     A {@link MHRHeader}.
     * @param requireIHINumber Is the IHINumber required?
     */
    public static void validate(MHRHeader commonHeader, boolean requireIHINumber) {
