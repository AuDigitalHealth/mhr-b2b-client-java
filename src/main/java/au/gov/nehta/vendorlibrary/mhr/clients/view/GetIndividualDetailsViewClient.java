...
public class GetIndividualDetailsViewClient extends Client<GetIndividualDetailsViewPortType> {
     ...
     * @throws au.net.electronichealth.ns.mhr.svc.getindividualdetailsview._2.StandardErrorMsg Thrown in the event that the operation fails.
     * @throws StandardErrorMsg                                                                  Thrown in the event that the operation fails.
     */
    public final GetIndividualDetailsViewResponse getIndividualDetailsView(final MHRHeader commonHeader) throws StandardErrorMsg {
