...
import au.net.electronichealth.ns.mhr.svc.getindividualdetailsview._2.GetIndividualDetailsViewPortType;
import au.net.electronichealth.ns.mhr.svc.getindividualdetailsview._2.GetIndividualDetailsViewService;
import au.net.electronichealth.ns.mhr.svc.getindividualdetailsview._2.StandardErrorMsg;
...
import au.net.electronichealth.ns.mhr.xsd.interfaces.getindividualdetailsview._2.GetIndividualDetailsViewResponse;
...
public class GetIndividualDetailsViewClient extends Client<GetIndividualDetailsViewPortType> {
         ...
         * @return response (type {@link GetRepresentativeListResponse}) containing
         *         representative list.
         * @throws au.net.electronichealth.ns.mhr.svc.getindividualdetailsview._2.StandardErrorMsg Thrown
         *                                                                                         in
         *                                                                                         the
         *                                                                                         event
         *                                                                                         that
         ...
         *                                                                                         operation
         *                                                                                         fails.
         * @throws StandardErrorMsg                                                                Thrown
         *                                                                                         in
         *                                                                                         the
         *                                                                                         event
         *                                                                                         that
         ...
         *                                                                                         fails.
         */
        public final GetIndividualDetailsViewResponse getIndividualDetailsView(final MHRHeader commonHeader)
