 ...
 * under the License.
 */
package au.gov.nehta.vendorlibrary.mhr.clients.common;
...
import au.gov.nehta.vendorlibrary.mhr.clients.common.handler.IMTOMHandler;
import au.gov.nehta.vendorlibrary.mhr.clients.common.handler.SecurityHandler;
...
public abstract class Client<PortType> {
     ...
     * @param endpointAddress     the endpoint address of the web service (mandatory).
     * @param setLoggingEnabled   set to <code>true</code> to enable logging (mandatory).
     * @param customMtomHandler   the MTOM handler
     */
    public Client(
            final Class<? extends Service> serviceClass,
            final Class<PortType> portClass,
