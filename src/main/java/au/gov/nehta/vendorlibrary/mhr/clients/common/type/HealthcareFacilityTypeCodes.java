...
public enum HealthcareFacilityTypeCodes {
  ...
  /**
   * Retrieves a {@link au.gov.nehta.vendorlibrary.mhr.clients.common.type.HealthcareFacilityTypeCodes} based on a supplied concept code.
   *
   * @param conceptCode Concept to search for.
   * @return Corresponding {@link au.gov.nehta.vendorlibrary.mhr.clients.common.type.HealthcareFacilityTypeCodes} or null.
   */
