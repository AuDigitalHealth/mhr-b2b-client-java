 ...
 * under the License.
 */
package au.gov.nehta.vendorlibrary.mhr.clients.common.type;
...
/**
 * {@link au.gov.nehta.vendorlibrary.mhr.clients.common.type.CX}
...
public final class CX {
  ...
  /**
   * Private constructor to set {@link au.gov.nehta.vendorlibrary.mhr.clients.common.type.CX} instance variables.
   *
   * @param builder {@link au.gov.nehta.vendorlibrary.mhr.clients.common.type.CX.Builder} to construct
   *                {@link au.gov.nehta.vendorlibrary.mhr.clients.common.type.CX} from.
   */
  ...
  /**
   * Parse multiple {@link au.gov.nehta.vendorlibrary.mhr.clients.common.type.CX} objects from string.
   *
   * @param value     String to be parsed (not null nor blank).
   * @param separator {@link au.gov.nehta.vendorlibrary.mhr.clients.common.type.CX} list delimiter (not null or blank).
   * @return List of {@link au.gov.nehta.vendorlibrary.mhr.clients.common.type.CX}.
   */
  ...
  /**
   * Outputs a {@link au.gov.nehta.vendorlibrary.mhr.clients.common.type.CX} in the following format:
  ...
  /**
   * Parse {@link au.gov.nehta.vendorlibrary.mhr.clients.common.type.CX} from string.
   *
   * @param parseValue String to be parsed (not null).
   * @return {@link au.gov.nehta.vendorlibrary.mhr.clients.common.type.CX}
   */
  ...
  /**
   * {@link au.gov.nehta.vendorlibrary.mhr.clients.common.type.CX.Builder}
   * Build class used to construct and validate a {@link au.gov.nehta.vendorlibrary.mhr.clients.common.type.CX} object.
   */
  public static final class Builder {
     ...
     * @return {@link au.gov.nehta.vendorlibrary.mhr.clients.common.type.CX.Builder}
     */
    ...
    /**
     * Build {@link au.gov.nehta.vendorlibrary.mhr.clients.common.type.CX} and validate necessary fields.
     *
     * @return {@link au.gov.nehta.vendorlibrary.mhr.clients.common.type.CX}
     */
    public CX build() {
