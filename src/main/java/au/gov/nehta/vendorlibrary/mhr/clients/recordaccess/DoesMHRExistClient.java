 ...
 */
public class DoesMHRExistClient extends Client<MHRProfilePortType> {
     ...
     * @return response (type {@link DoesMHRExistResponse}) containing check results.
     * @throws StandardErrorMsg thrown in the event of an operation invocation error.
     */
    public final DoesMHRExistResponse doesPCEHRExist(final MHRHeader commonHeader) throws StandardErrorMsg {
        ...
        Holder<DoesMHRExistResponse> responseHolder = new Holder<>();
