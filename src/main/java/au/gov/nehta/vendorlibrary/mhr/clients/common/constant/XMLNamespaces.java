 ...
 * under the License.
 */
package au.gov.nehta.vendorlibrary.mhr.clients.common.constant;

/**
 * {@link au.gov.nehta.vendorlibrary.mhr.clients.common.constant.XMLNamespaces} XML namespaces used in generating a package.
 */
public enum XMLNamespaces {
    ...
    XMLNamespaces(String prefix, String namespace) {
        this.prefix = prefix;
    ...
    /**
     * Retrieves a {@link au.gov.nehta.vendorlibrary.mhr.clients.common.constant.XMLNamespaces} based on a supplied prefix.
     *
     * @param prefix Prefix to search for.
     * @return Corresponding {@link au.gov.nehta.vendorlibrary.mhr.clients.common.constant.XMLNamespaces} or null.
     */
    ...
    /**
     * Retrieves a {@link au.gov.nehta.vendorlibrary.mhr.clients.common.constant.XMLNamespaces} based on a supplied namespace URI.
     *
