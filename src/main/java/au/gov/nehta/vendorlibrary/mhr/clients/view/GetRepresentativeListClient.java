...
import au.net.electronichealth.ns.mhr.svc.getrepresentativelist._1.GetRepresentativeListPortType;
import au.net.electronichealth.ns.mhr.svc.getrepresentativelist._1.GetRepresentativeListService;
...
public class GetRepresentativeListClient extends Client<GetRepresentativeListPortType> {
         ...
         */
        public final GetRepresentativeListResponse getRepresentativeList(final MHRHeader commonHeader)
                ...
                Holder<GetRepresentativeListResponse> responseHolder = new Holder<>();
