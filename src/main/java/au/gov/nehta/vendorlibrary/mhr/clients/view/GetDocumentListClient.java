...
public final class GetDocumentListClient extends Client<DocumentRegistryPortType> {
     ...
     */
    public AdhocQueryResponse getDocumentList(MHRHeader commonHeader) {
     ...
     * @return A list of the metadata of matching documents.
     */
    public AdhocQueryResponse getDocumentList(MHRHeader commonHeader, DocumentQueryParams queryParams) {
