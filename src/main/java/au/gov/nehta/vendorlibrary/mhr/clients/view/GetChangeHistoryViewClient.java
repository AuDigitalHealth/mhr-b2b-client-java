...
import au.net.electronichealth.ns.mhr.svc.getchangehistoryview._1.GetChangeHistoryViewService;
import au.net.electronichealth.ns.mhr.svc.getchangehistoryview._1.StandardErrorMsg;
...
import au.net.electronichealth.ns.mhr.xsd.interfaces.getchangehistoryview._1.GetChangeHistoryView;
import au.net.electronichealth.ns.mhr.xsd.interfaces.getchangehistoryview._1.GetChangeHistoryViewResponse;
...
public final class GetChangeHistoryViewClient extends Client<GetChangeHistoryViewPortType> {
     ...
     */
    public GetChangeHistoryViewResponse getChangeHistoryView(MHRHeader commonHeader, String documentId) throws StandardErrorMsg {
