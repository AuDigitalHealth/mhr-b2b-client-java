...
public enum PracticeSettingTypeCodes {
  ...
  /**
   * Retrieves a {@link au.gov.nehta.vendorlibrary.mhr.clients.common.type.PracticeSettingTypeCodes} based on a supplied concept code.
   *
   * @param conceptCode Concept to search for.
   * @return Corresponding {@link au.gov.nehta.vendorlibrary.mhr.clients.common.type.PracticeSettingTypeCodes} or null.
   */
