 ...
 * under the License.
 */
package au.gov.nehta.vendorlibrary.mhr.clients.common.handler;

import au.gov.nehta.common.utils.ArgumentUtils;
import au.gov.nehta.vendorlibrary.mhr.clients.common.constant.XMLNamespaces;
import au.gov.nehta.vendorlibrary.mhr.clients.common.exception.CertificateVerificationException;
import au.gov.nehta.vendorlibrary.mhr.clients.common.exception.SignatureValidationException;
import au.gov.nehta.vendorlibrary.mhr.clients.common.exception.SignatureVerificationException;
import au.gov.nehta.vendorlibrary.mhr.clients.common.util.HandlerUtils;
...
public class SecurityHandler implements SOAPHandler<SOAPMessageContext> {
    ...
    /**
     * MHRHeader XML element local name.
     */
    public static final String PCEHRH_HEADER_ELEM = "___SOAP_MHRHeader___";
    ...
    /**
     * The certificate verifier (now validator).
     */
    ...
    private void checkResponse(final SOAPMessageContext context) {
        ...
        XmlSignatureProfileService xmlSignatureProfileService;
        try {
        ...
        } catch (XspException | au.gov.nehta.xsp.SignatureValidationException | CertificateValidationException e) {
    ...
    private void signBodyAndSOAPHeaders(final SOAPMessageContext context) {
        ...
        } catch (SOAPException | XspException ex) {
    ...
    private void signSoapElements(Element timestampElement, Element headerElement, Element bodyElement, Element sigElement) throws XspException {
        ...
        List<X500PrivateCredential> certificateKeyPairs = Collections.singletonList(new X500PrivateCredential(x509Certificate, privateKey));
     ...
     * @throws au.gov.nehta.vendorlibrary.mhr.clients.common.exception.CertificateVerificationException thrown when signature extraction fails.
     */
