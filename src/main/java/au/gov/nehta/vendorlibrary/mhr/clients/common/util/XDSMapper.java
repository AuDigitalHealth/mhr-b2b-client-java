...
import au.gov.nehta.vendorlibrary.mhr.clients.common.type.Author;
...
import au.gov.nehta.vendorlibrary.mhr.clients.common.type.SubmissionMetadata;
...
public final class XDSMapper {
     ...
     */
    public static SubmitObjectsRequest toSubmitObjectsRequest(MHRHeader commonHeader,
        ...
        Holder<Integer> idAsCounter = new Holder<>(0);
        Holder<Integer> idEiCounter = new Holder<>(0);
...
//    }
     ...
     */
    public static AdhocQueryRequest toAdhocQueryRequest(MHRHeader commonHeader,
                                                        String queryId,
    ...
    public static DocumentQueryParams getDocumentQueryParams(MHRHeader commonHeader, AdhocQueryRequest queryRequest) {
        ...
        if (!StringUtils.equals(commonHeader.getIhiNumber(), patientId)) {
            throw new IllegalArgumentException(
                    String.format(
                            "The MHRHeader.IHINumber [%s] does not equal the %s parameter in the AdhocQuery [%s].",
    ...
    private static ClassificationType getClassification(List<ClassificationType> classifications,
    ...
    private static List<CodedValue> getQuerySlotCodedValues(List<Slot> slots, String slotName) {
        ...
        if (valueSlot != null) {
            ...
            codedValues = new ArrayList<>(values.size());
