 ...
 * under the License.
 */
package au.gov.nehta.vendorlibrary.mhr.clients.documentexchange;
...
import au.gov.nehta.vendorlibrary.mhr.clients.common.type.ConfidentialityCodes;
...
import au.gov.nehta.vendorlibrary.mhr.clients.common.util.XDSMapper;
...
public final class UploadDocumentClient extends Client<DocumentRepositoryPortType> {
     ...
     * @throws SAXException                 If parsing exception occurs.
     * @throws XPathExpressionException     If expression error occurs.
     * @throws ParserConfigurationException If config error occurs.
     */
