...
import au.net.electronichealth.ns.mhr.svc.getauditview._1.GetAuditViewPortType;
import au.net.electronichealth.ns.mhr.svc.getauditview._1.GetAuditViewService;
import au.net.electronichealth.ns.mhr.svc.getauditview._1.StandardErrorMsg;
...
import au.net.electronichealth.ns.mhr.xsd.interfaces.getauditview._1.GetAuditView;
import au.net.electronichealth.ns.mhr.xsd.interfaces.getauditview._1.GetAuditViewResponse;
...
public final class GetAuditViewClient extends Client<GetAuditViewPortType> {
     ...
     */
    public GetAuditViewResponse getAuditView(MHRHeader commonHeader, Date dateFrom, Date dateTo) throws StandardErrorMsg {
