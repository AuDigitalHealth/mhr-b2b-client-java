...
//  PRESCRIPTION_REQUEST("NCTIS", "1.2.36.1.2001.1001.101", "100.16285", "Prescription Request", "Prescription Request"),
    ...
    DocumentTypeCodes(String codingSystem, String codingSystemOid, String code, String classCodeDisplayName, String typeCodeDisplayName) {
    ...
    /**
     * Retrieves a {@link au.gov.nehta.vendorlibrary.mhr.clients.common.type.DocumentTypeCodes} based on a supplied concept code.
     *
     * @param conceptCode Concept to search for.
     * @return Corresponding {@link au.gov.nehta.vendorlibrary.mhr.clients.common.type.DocumentTypeCodes} or null.
     */
