...
public class GetViewClient extends Client<GetViewPortType> {
   ...
   * NOT YET SUPPORTED
   *
  public final GetViewResponse getView(MHRHeader commonHeader, AchievementDiaryView getViewRequestObject) throws StandardErrorMsg {
  ...
  */
     ...
     * @throws StandardErrorMsg Thrown in the event that the operation fails.
     */
    public final GetViewResponse getView(MHRHeader commonHeader, MedicareOverview getViewRequestObject) throws StandardErrorMsg {
        return getView(commonHeader, (Object) getViewRequestObject);
    }
     ...
     * @throws StandardErrorMsg Thrown in the event that the operation fails.
     */
    public final GetViewResponse getView(MHRHeader commonHeader, ObservationView getViewRequestObject) throws StandardErrorMsg {
        return getView(commonHeader, (Object) getViewRequestObject);
    }
     ...
     * @throws StandardErrorMsg Thrown in the event that the operation fails.
     */
    public final GetViewResponse getView(MHRHeader commonHeader, PrescriptionAndDispenseView getViewRequestObject) throws StandardErrorMsg {
        return getView(commonHeader, (Object) getViewRequestObject);
    }
     ...
     * @throws StandardErrorMsg Thrown in the event that the operation fails.
     */
    public final TypedViewResponse<PathologyReportViewResponse> getView(MHRHeader commonHeader, PathologyReportView getViewRequestObject) throws StandardErrorMsg {
     ...
     * @throws StandardErrorMsg Thrown in the event that the operation fails.
     */
    public final TypedViewResponse<DiagnosticImagingReportViewResponse> getView(MHRHeader commonHeader, DiagnosticImagingReportView getViewRequestObject) throws StandardErrorMsg {
        GetViewResponse viewResponse = getView(commonHeader, (Object) getViewRequestObject);
     ...
     * @throws StandardErrorMsg Thrown in the event that the operation fails.
     */
    public final TypedViewResponse<HealthRecordOverviewResponse> getView(MHRHeader commonHeader, HealthRecordOverView getViewRequestObject) throws StandardErrorMsg {
        GetViewResponse viewResponse = getView(commonHeader, (Object) getViewRequestObject);
     ...
     * @throws StandardErrorMsg Thrown in the event that the operation fails.
     */
    public final GetViewResponse getView(MHRHeader commonHeader, HealthCheckScheduleView getViewRequestObject) throws StandardErrorMsg {
        return getView(commonHeader, (Object) getViewRequestObject);
    }
