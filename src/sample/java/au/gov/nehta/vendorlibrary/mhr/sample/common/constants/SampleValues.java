 ...
 * under the License.
 */
package au.gov.nehta.vendorlibrary.mhr.sample.common.constants;
...
public final class SampleValues {
   ...
   * User - ID type.
   */
  public static final MHRHeader.User.IDType USER_ID_TYPE = MHRHeader.User.IDType.HPII;
   ...
   */
  public static final MHRHeader.ClientSystemType CLIENT_SYSTEM_TYPE_CIS = MHRHeader.ClientSystemType.CIS;

  /**
   * Client system type - CRP.
   */
  public static final MHRHeader.ClientSystemType CLIENT_SYSTEM_TYPE_CRP = MHRHeader.ClientSystemType.CRP;
   ...
   */
  public static final GainMHRAccess.MHRRecord.AuthorisationDetails.AccessType AUTHORISATION_DETAILS_ACCESS_TYPE = GainMHRAccess.MHRRecord.AuthorisationDetails.AccessType.EMERGENCY_ACCESS;
