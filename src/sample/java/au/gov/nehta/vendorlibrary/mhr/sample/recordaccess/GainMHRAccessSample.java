 ...
 * under the License.
 */
package au.gov.nehta.vendorlibrary.mhr.sample.recordaccess;
...
public final class GainMHRAccessSample {
  ...
  public static void main(String[] args) throws IOException, GeneralSecurityException, StandardErrorMsg {
    ...
    GainMHRAccess.MHRRecord.AuthorisationDetails authorisationDetails = MessageComponents.createAuthorisationDetails(
    ...
    GainMHRAccess.MHRRecord record = MessageComponents.createGainMHRRecord(authorisationDetails);
    ...
    // Call operation.
    GainMHRAccessResponse response = client.gainPCEHRAccess(record, commonHeader);
